...
if (projectsContainer) {
    fetch('projects.json') // Assuming projects.json is in the public/ root directory
        ...
        .catch(error => {
            ...
            projectsContainer.innerHTML = '<p class="text-center text-red-400">Failed to load projects. Please try again later.</p>';
        });
}
...
if (testimonialsContainer) {
    fetch('testimonials.json') // Assuming testimonials.json is in the public/ root directory
        ...
        .catch(error => {
            ...
            testimonialsContainer.innerHTML = '<p class="text-center text-red-400">Failed to load testimonials. Please try again later.</p>';
        });
}
